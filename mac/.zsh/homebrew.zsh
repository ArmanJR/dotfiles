...
# Add Homebrew to PATH if it exists and not already initialized
# (Check if HOMEBREW_REPOSITORY is set to avoid duplicate initialization)
if [[ -x "$HOMEBREW_PREFIX/bin/brew" ]] && [[ -z "$HOMEBREW_REPOSITORY" ]]; then
